...
values."
  ...
  (add-to-list 'exec-path "/root/.local/bin/")
  (add-to-list 'exec-path "/root/.cabal/bin/")
)
...
(custom-set-variables
 ...
 '(idris-interpreter-path "/root/.local/bin/idris")
...
(custom-set-faces
 ...
 ;; Your init file should contain only one such instance.
 ;; If there is more than one, they won't work right.
 '(idris-active-term-face ((t (:inherit nil))))
 '(idris-colon-face ((t (:foreground "white" :weight light))))
 '(idris-directive-face ((t (:foreground "dark gray"))))
 '(idris-equals-face ((t (:foreground "white" :weight bold))))
 '(idris-hole-face ((t (:foreground "orange red" :slant italic :weight bold))))
 '(idris-inline-doc-face ((t (:foreground "pale green"))))
 '(idris-keyword-face ((t (:foreground "gainsboro" :weight bold))))
 '(idris-operator-face ((t (:foreground "white" :weight light))))
 '(idris-parameter-face ((t (:foreground "plum3"))))
 '(idris-semantic-bound-face ((t (:foreground "thistle3"))))
